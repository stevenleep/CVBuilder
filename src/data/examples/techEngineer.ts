          ...
          children: [
            {
              ...
              props: {
                ...
                startDate: '2022.03',
                endDate: '2023.12',
                tech: 'React 18, TypeScript, Ant Design Pro, ECharts, D3.js, React Query',
              },
              style: {
                marginBottom: '20px',
              },
            ...
            },
            {
              ...
              props: {
                ...
                startDate: '2021.09',
                endDate: '2022.02',
                tech: 'qiankun, Vite, pnpm, Monorepo',
              },
              style: {},
              children: [
                {
          ...
          children: [
            {
              ...
              props: {
                content:
                  '• <strong>GitHub</strong>：活跃贡献者，个人项目累计获得 3200+ stars，参与多个知名开源项目（Ant Design、Vue Router）\n• <strong>开源项目</strong>：维护 React 业务组件库 react-advanced-ui，npm 周下载量 8000+，被 200+ 项目使用\n• <strong>技术博客</strong>：掘金 LV6 创作者，发表原创技术文章 50+ 篇，总阅读量 60w+，多篇文章被掘金官方推荐\n• <strong>技术分享</strong>：内部分享《微前端架构实践》《前端性能优化指南》，公司前端月会技术出品人',
              },
              style: {},
              children: [],
            },
          ...
          children: [
            {
              ...
              props: {
                ...
                endDate: '至今',
                location: '北京',
                description: '企业协作产品团队，负责核心业务前端架构设计与技术攻坚',
              },
              style: {
                marginBottom: '20px',
              },
            ...
            },
            {
              ...
              props: {
                ...
                endDate: '2021.05',
                location: '北京',
                description: '商家平台部，负责 ToB 端商家管理后台和数据看板开发',
              },
              style: {
                marginBottom: '20px',
              },
            ...
            },
            {
              ...
              props: {
                ...
                endDate: '2019.02',
                location: '北京',
                description: '负责公司核心产品前端开发，参与从 0 到 1 的产品搭建',
              },
              style: {},
              children: [
                {
              ...
              children: [
                {
                  ...
                  props: {
                    items: [
                      'GPA: 3.7/4.0，专业课平均分 88 分',
                      '获得校级一等奖学金（2 次）、三好学生称号',
                      '担任计算机学院科技协会技术部部长，组织多场技术分享会',
          ...
          children: [
            {
              ...
              props: {
                content:
                  '• 2023 年度公司优秀员工（Top 5%）\n• 2022 年公司黑客马拉松大赛一等奖（团队项目：智能代码审查工具）\n• CET-6（英语六级），具备良好的英文文档阅读能力',
              },
              style: {},
              children: [],
            },
